...
| Données du moment 1        | section_actu_data         | 3 cards dynamiques  | Jeux les plus consultés / réutilisés / nouveaux (sort=-views, -reuses, -created_at)         | bloc_jeux_populaires.md      | En cours      |
...
| Données du moment 2        | section_actu_data         | 3 cards éditoriales | Jeu du mois, données de référence (tag=base-reference), lien forum.data.gouv.fr/tag/culture | section_actu_data_culture.md | En cours      |
